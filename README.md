...
**Backlog и идеи по тулам** ведутся в каноне заметок: `knowledge/work/projects/current-projects/roslyn-mcp/README.md` в репозитории **agent-notes** (не дублировать длинный текст в этом репо).
